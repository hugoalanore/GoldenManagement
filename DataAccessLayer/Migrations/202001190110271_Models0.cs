    ...
    public partial class Models0 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DOMAINE_FORMATION", t => t.Domaine_Id)
                .Index(t => t.Domaine_Id);
            
            CreateTable(
                "dbo.DOMAINE_FORMATION",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        EstActif = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.FORMATION", new[] { "Domaine_Id" });
            ...
            DropTable("dbo.DOMAINE_FORMATION");
